...
void print_summary_text_file(WAV_HEADER &wavHeader,
                             ...
                             uint64_t numSamples,
                             int32_t max_channel_1_pre_noise,
                             int32_t max_channel_2_pre_noise,
                             int32_t max_channel_1_post_noise,
                             int32_t max_channel_2_post_noise)
{
        ...
        test_file << std::left << std::setw(50) << "Number of samples:" << numSamples << std::endl;
